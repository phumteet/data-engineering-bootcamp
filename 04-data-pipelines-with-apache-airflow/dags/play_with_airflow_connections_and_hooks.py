...
with DAG(
    ...
    dump_product_data = PythonOperator(
        ...
        python_callable=_dump_data, #python_callable เป็นการ function สามารถส่ง args ได้ (in this case pass to _dump_data() )
        op_kwargs={"table": "products"}, #โดยใช้ op_kwargs (keyword) or op_args (arguments)
    )
