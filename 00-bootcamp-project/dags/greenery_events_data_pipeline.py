...
def _load_data_to_gcs(ds):
    keyfile_gcs = "/opt/airflow/dags/braided-destiny-384416-574e91f953a2-bigquery-to-gcs.json"
...
def _load_data_from_gcs_to_bigquery(ds):
    ...
    blob = bucket.blob(destination_blob_name)
    if blob.exists():
        keyfile_bigquery = "/opt/airflow/dags/braided-destiny-384416-574e91f953a2-bigquery-to-gcs.json"
        ...
        table_id = f"{PROJECT_ID}.deb_bootcamp.{DATA}1${partition}"
